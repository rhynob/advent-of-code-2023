 ...
 * You gentlyland in a fluffy pile of leaves. It's quite cold, but you don't see
 * much snow. An Elf runs over to greet you.
 *
 * The Elf explains that you've arrived at Snow Island and apologizes for the
 * lack of snow. He'll be happy to explain the situation, but it's a bit
 * of a walk, so you have some time. They don't get many visitors up here; would
 ...
 */
fn main() {
    // I incorrectly assumed that I needed to add all the matches together to
    // determine if the game was possible.
